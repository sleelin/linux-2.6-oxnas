...
#define OX800SATA_RAID1 (OX800SATA_RAID_MIR0 | OX800SATA_RAID_MIR_EN | OX800SATA_RAID_OVERLAP )
#define OX800SATA_RAID0 (OX800SATA_RAID_OVERLAP | OX800SATA_RAID_STRI_EN )
/**
...
#define OX800SATA_VERS_921 0xE0
#define OX800SATA_VERS_924 0xE1
#define OX800SATA_VERS_NAS 0xf0
...
extern int  ox800sata_RAID_faults( void );
extern int	ox800sata_get_port_no(request_queue_t* );
extern int ox800sata_LBA_schemes_compatible( void );
